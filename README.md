...
[cite_start]Python uses the C3 Linearization algorithm to determine the Method Resolution Order (MRO) when dealing with multiple inheritance[cite: 187, 304]. 
...
[cite_start]The C3 Linearization algorithm ensures that a subclass is always checked before its parents, and the order of the parent classes is strictly preserved[cite: 187].
